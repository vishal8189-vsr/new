...
if(isset($_POST['done'])){
    ...
    $gid=$_POST['gid'];
    $cid=$_POST['cid'];
    $q="UPDATE `equipment` SET `eid`='$id',`ename`='$ename',`gid`='$gid',`cid`='$cid' WHERE eid='$id'";
...
<!-- <button class="btn btn-success" type="next" name="next" ><a href="http://localhost/project/emp/insert.php">Next</button><br> -->
</div>
</form>
</body>
</html>